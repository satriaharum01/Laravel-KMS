					...
					<table id="basic-data-table" class="table" style="width:100%">
						<thead>
							<tr>
								...
								<th style="text-align:center;" width="">Diskusi</th>
            ...
            columns: [{
                ...
                },
                {
                    data: 'fill', className:'text-left',render: function(data){
                        return '<h4>'+data[1]+'</h4><br><div><i class="fa fa-edit"></i> '+data[3]+' <i class="fa fa-calendar"></i> '+data[4]+' <i class="fa fa-clock"></i> '+data[5]+'</div>';
                    }
                },
                {
                    data: 'id',
